...
```text
❌ I am always going to work by car. (Using 'always' for a normal routine should be simple tense)
...
* Common state verbs: `like, want, need, prefer, know, realise, suppose, mean, understand, believe, remember, belong, fit, contain, consist, seem`.
* You must use the **Present Simple** for these verbs.
